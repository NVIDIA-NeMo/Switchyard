...
| **[System Prompt Judge](docs/routing_algorithms/system_prompt_judge_routing.md)** | A judge chooses one hidden system prompt from a text DB before a passthrough call. | `system_prompt_judge` | not yet benchmarked |
