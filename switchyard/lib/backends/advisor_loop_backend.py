...
fires regardless of the executor's own tool-use discipline.
...
class AdvisorLoopBackend(LLMBackend):
    ...
    def __init__(
        ...
        *,
        ...
        self._request_type = request_type_enum(self._request_type_name)
    ...
    async def call(self, ctx: ProxyContext, request: ChatRequest) -> ChatResponse:
        ...
        # cost output prices this proxy-internal turn.
...
def _with_length_line(
    ...
    parts, valid on both the Anthropic and OpenAI wires. Used by
    ``seed_plan_advice`` for the seeded upfront plan.
    """
