...
mod tests {
    ...
    fn algo(threshold: f64, score: &str) -> (LlmClassifierOrch, Arc<Mutex<Vec<Request>>>) {
    ...
    fn orch(algo: LlmClassifierOrch) -> Arc<dyn Algorithm> {
        Arc::new(algo)
    }
