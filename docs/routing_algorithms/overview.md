...
| [TypeSafe Classifier Routing](type_safe_classifier_routing.md) | Request content should decide the tier, without spending a chat-completion call on the judgment step. | `type_safe_classifier` |
