---
title: "Escalation-Router Routing"
description: "Start agent tasks on a weak model and latch them to a strong model when an LLM judge detects sustained trouble."
position: 6
---
