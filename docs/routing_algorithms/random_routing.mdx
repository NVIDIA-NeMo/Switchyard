...
description: "Split traffic between strong and weak model targets with a fixed probability."
position: 2
---
...
[LLM Classifier Routing](/routing/llm-classifier-routing) or
[Stage-Router Routing](/routing/stage-router-routing).
...
[Sticky Routing](/routing/sticky-routing) where it is supported, or select a direct
